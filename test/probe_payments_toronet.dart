...
void main() async {
  ...
  final baseUrls = [
    'https://payments.toronet.org/api',
    'https://payments.toronet.org',
  ];
  ...
  print('=== Probing generatevirtualwallet on payments.toronet.org ===');
  final generateData = {
  ...
  print('\n=== Probing getvirtualwalletbyaddress on payments.toronet.org ===');
  final getData = {
