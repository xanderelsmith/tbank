...
void main() {
  ...
  File? paymentsApiFile;
  for (final file in dartFiles) {
    if (p.basename(file.path) == 'payments_api.dart') {
      paymentsApiFile = file;
      break;
    }
  }
  
  if (paymentsApiFile != null) {
    print('\n--- payments_api.dart file ---');
    print(paymentsApiFile.readAsStringSync());
  } else {
    print('payments_api.dart file not found.');
  }
}
